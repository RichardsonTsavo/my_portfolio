...
class MobileCalculationsPage extends StatefulWidget {
  final CalculationsController controller;
  final String title;
  MobileCalculationsPage({this.title, this.controller});

  @override
  _MobileCalculationsPageState createState() => _MobileCalculationsPageState();
}

class _MobileCalculationsPageState extends State<MobileCalculationsPage> {
                  ...
                  children: [
                    Observer(
                      builder: (context) => ToggleButtons(
                          ...
                          children: [
                            Text(" Find out\nyour age! ",textAlign: TextAlign.center,),
                            Text(" BMI\ncalculator ",textAlign: TextAlign.center),
